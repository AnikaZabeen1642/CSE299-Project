...
import 'package:medi_app/models/errors.dart';
import 'package:medi_app/models/medicine.dart';
import 'package:medi_app/pages/home_page.dart';
import 'package:medi_app/pages/new_entry/new_entry_bloc.dart';
import 'package:medi_app/pages/success_screen.dart';
...
extension on FlutterLocalNotificationsPlugin {
  showDailyAtTime(int parse, String s, String t, time, NotificationDetails platformChannelSpecifics) {}
}
